...
function Card({ item, changeFlag,showCart }) {
    ...
    return (
        <div id={item._id} className="flex w-full lg:w-1/4 md:w-1/3 hover:bg-gray-100 hover:ease-in hover:delay-300 pb-4 rounded-md flex-col">
            ...
            <div className="flex justify-around">
                <button style={{ cursor: "pointer" }} nClick={() => addCart(item)} className='text-xl h-10 px-5 rounded-md font-semibold hover:bg-gray-300'>Buy</button>
